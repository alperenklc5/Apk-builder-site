...
.method public final applyAndAckSettings(ZLokhttp3/internal/http2/Settings;)V
    ...
    .line 735
    .local v9, "delta":Lkotlin/jvm/internal/Ref$LongRef;
    new-instance v10, Lkotlin/jvm/internal/Ref$ObjectRef;

    invoke-direct {v10}, Lkotlin/jvm/internal/Ref$ObjectRef;-><init>()V

    .line 736
    .local v10, "streamsToNotify":Lkotlin/jvm/internal/Ref$ObjectRef;
    ...
    .line 738
    .local v12, "$i$a$-synchronized-Http2Connection$ReaderRunnable$applyAndAckSettings$1":I
    :try_start_0
    ...
    .line 739
    .local v14, "$i$a$-synchronized-Http2Connection$ReaderRunnable$applyAndAckSettings$1$1":I
    :try_start_1
    iget-object v0, v5, Lokhttp3/internal/http2/Http2Connection$ReaderRunnable;->this$0:Lokhttp3/internal/http2/Http2Connection;
    ...
    .line 740
    .local v15, "previousPeerSettings":Lokhttp3/internal/http2/Settings;
    if-eqz p1, :cond_0
    ...
    .line 744
    .local v2, "$i$a$-apply-Http2Connection$ReaderRunnable$applyAndAckSettings$1$1$1":I
    ...
    .end local v2    # "$i$a$-apply-Http2Connection$ReaderRunnable$applyAndAckSettings$1$1$1":I
    ...
    .line 750
    .local v0, "peerInitialWindowSize":J
    ...
    .end local v0    # "peerInitialWindowSize":J
    .local v16, "peerInitialWindowSize":J
    ...
    .end local v9    # "delta":Lkotlin/jvm/internal/Ref$LongRef;
    .end local v10    # "streamsToNotify":Lkotlin/jvm/internal/Ref$ObjectRef;
    .end local v12    # "$i$a$-synchronized-Http2Connection$ReaderRunnable$applyAndAckSettings$1":I
    ...
    .end local v4    # "$i$f$toTypedArray":I
    .end local v7    # "thisCollection$iv":Ljava/util/Collection;
    .end local v14    # "$i$a$-synchronized-Http2Connection$ReaderRunnable$applyAndAckSettings$1$1":I
    .end local v15    # "previousPeerSettings":Lokhttp3/internal/http2/Settings;
    .end local v16    # "peerInitialWindowSize":J
    .restart local v6    # "newPeerSettings":Lkotlin/jvm/internal/Ref$ObjectRef;
    .restart local v9    # "delta":Lkotlin/jvm/internal/Ref$LongRef;
    .restart local v10    # "streamsToNotify":Lkotlin/jvm/internal/Ref$ObjectRef;
    .restart local v12    # "$i$a$-synchronized-Http2Connection$ReaderRunnable$applyAndAckSettings$1":I
    ...
    .line 752
    .restart local v0    # "peerInitialWindowSize":J
    .restart local v14    # "$i$a$-synchronized-Http2Connection$ReaderRunnable$applyAndAckSettings$1$1":I
    .restart local v15    # "previousPeerSettings":Lokhttp3/internal/http2/Settings;
    :cond_3
    move-wide/from16 v16, v0

    .end local v0    # "peerInitialWindowSize":J
    .restart local v16    # "peerInitialWindowSize":J
    :goto_1
    const/4 v0, 0x0
    ...
    .end local v12    # "$i$a$-synchronized-Http2Connection$ReaderRunnable$applyAndAckSettings$1":I
    .local v18, "$i$a$-synchronized-Http2Connection$ReaderRunnable$applyAndAckSettings$1":I
    ...
    .local v21, "this_$iv":Lokhttp3/internal/concurrent/TaskQueue;
    move v4, v2
    ...
    .local v21, "peerInitialWindowSize":J
    ...
    .end local v15    # "previousPeerSettings":Lokhttp3/internal/http2/Settings;
    .end local v20    # "$i$f$execute":I
    .end local v21    # "peerInitialWindowSize":J
    nop
    ...
    .end local v18    # "$i$a$-synchronized-Http2Connection$ReaderRunnable$applyAndAckSettings$1":I
    sget-object v0, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
    :try_end_7
    ...
    .line 738
    .restart local v18    # "$i$a$-synchronized-Http2Connection$ReaderRunnable$applyAndAckSettings$1":I
    :catchall_2
    move-exception v0
...
.method public headers(ZIILjava/util/List;)V
    ...
    .line 663
    invoke-virtual {v11, v1, v9, v4}, Lokhttp3/internal/http2/Http2Connection;->pushHeadersLater$okhttp(ILjava/util/List;Z)V
    ...
    .line 683
    .local v5, "newStream":Lokhttp3/internal/http2/Http2Stream;
    :try_start_5
    iget-object v0, v6, Lokhttp3/internal/http2/Http2Connection$ReaderRunnable;->this$0:Lokhttp3/internal/http2/Http2Connection;
    ...
    .end local v16    # "delayNanos$iv":J
    .local v12, "delayNanos$iv":J
    .local v18, "$i$a$-synchronized-Http2Connection$ReaderRunnable$headers$1":I
    ...
    .end local v1    # "name$iv":Ljava/lang/String;
    .end local v2    # "cancelable$iv":Z
    .end local v5    # "newStream":Lokhttp3/internal/http2/Http2Stream;
    .end local v12    # "delayNanos$iv":J
    .end local v14    # "this_$iv":Lokhttp3/internal/concurrent/TaskQueue;
    .end local v15    # "$i$f$execute":I
    .end local v18    # "$i$a$-synchronized-Http2Connection$ReaderRunnable$headers$1":I
...
.method public settings(ZLokhttp3/internal/http2/Settings;)V
    ...
    .end local p1    # "clearPrevious":Z
    .end local p2    # "settings":Lokhttp3/internal/http2/Settings;
    .local v8, "clearPrevious":Z
    .local v9, "settings":Lokhttp3/internal/http2/Settings;
