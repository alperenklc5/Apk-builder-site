...
.method public constructor <init>(Lokhttp3/internal/http2/Http2Connection$Builder;)V
    ...
    .end local v7    # "pingIntervalNanos":J
    :cond_2
    return-void
.end method
...
.method private final newStream(ILjava/util/List;Z)Lokhttp3/internal/http2/Http2Stream;
    ...
    .line 238
    .local v9, "stream":Lokhttp3/internal/http2/Http2Stream;
    const/4 v1, 0x0
    ...
    .end local v9    # "stream":Lokhttp3/internal/http2/Http2Stream;
    .end local v15    # "inFinished":Z
    ...
    .restart local v9    # "stream":Lokhttp3/internal/http2/Http2Stream;
    .restart local v12    # "$i$a$-synchronized-Http2Connection$newStream$1$1":I
...
.method public final pushRequestLater$okhttp(ILjava/util/List;)V
    ...
    .end local p2    # "requestHeaders":Ljava/util/List;
    .local v8, "streamId":I
    .local v9, "requestHeaders":Ljava/util/List;
    ...
    .end local v9    # "requestHeaders":Ljava/util/List;
    ...
    .restart local v9    # "requestHeaders":Ljava/util/List;
    :goto_0
    monitor-exit p0
...
.method public final pushResetLater$okhttp(ILokhttp3/internal/http2/ErrorCode;)V
    ...
    .local v8, "streamId":I
    .local v9, "errorCode":Lokhttp3/internal/http2/ErrorCode;
...
.method public final start(ZLokhttp3/internal/concurrent/TaskRunner;)V
    ...
    .end local v3    # "name$iv":Ljava/lang/String;
    .end local v4    # "cancelable$iv":Z
    .end local v7    # "delayNanos$iv":J
    .end local v9    # "$i$f$execute":I
    return-void
.end method
