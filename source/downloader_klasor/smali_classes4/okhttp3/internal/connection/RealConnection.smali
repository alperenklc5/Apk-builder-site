...
.method private final connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    .line 420
    .local v14, "maybeProtocol":Ljava/lang/String;
    move-object v9, v5
    ...
    .end local v14    # "maybeProtocol":Ljava/lang/String;
    .local v0, "success":Z
    if-eqz v5, :cond_6
...
.method public final connect(IIIIZLokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 179
    .local v9, "connectionSpecs":Ljava/util/List;
    ...
    .line 181
    .local v10, "connectionSpecSelector":Lokhttp3/internal/connection/ConnectionSpecSelector;
    iget-object v3, v1, Lokhttp3/internal/connection/RealConnection;->route:Lokhttp3/Route;
    ...
    .local v11, "routeException":Lokhttp3/internal/connection/RouteException;
    :goto_2
    nop
    ...
    .end local v11    # "routeException":Lokhttp3/internal/connection/RouteException;
    .local v0, "routeException":Lokhttp3/internal/connection/RouteException;
    goto :goto_9

    .line 229
    .end local v0    # "routeException":Lokhttp3/internal/connection/RouteException;
    .restart local v11    # "routeException":Lokhttp3/internal/connection/RouteException;
    :cond_a
    ...
    .line 766
    .end local v0    # "routeException":Lokhttp3/internal/connection/RouteException;
    .end local v9    # "connectionSpecs":Ljava/util/List;
    .end local v10    # "connectionSpecSelector":Lokhttp3/internal/connection/ConnectionSpecSelector;
    :cond_d
    move/from16 v13, p1
...
.method public final newWebSocketStreams$okhttp(Lokhttp3/internal/connection/Exchange;)Lokhttp3/internal/ws/RealWebSocket$Streams;
    ...
    .end local p1    # "exchange":Lokhttp3/internal/connection/Exchange;
    .local v3, "exchange":Lokhttp3/internal/connection/Exchange;
