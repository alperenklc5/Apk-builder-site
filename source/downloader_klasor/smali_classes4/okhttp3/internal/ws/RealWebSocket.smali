...
.method private final runWriter()V
    ...
    .line 460
    .local v4, "writerTask":Lokhttp3/internal/concurrent/Task;
    if-eqz v4, :cond_2
...
.method public final initReaderAndWriter(Ljava/lang/String;Lokhttp3/internal/ws/RealWebSocket$Streams;)V
    ...
    .line 255
    .local v9, "extensions":Lokhttp3/internal/ws/WebSocketExtensions;
    monitor-enter p0
    ...
    .end local p2    # "streams":Lokhttp3/internal/ws/RealWebSocket$Streams;
    .local v7, "name":Ljava/lang/String;
    .local v8, "streams":Lokhttp3/internal/ws/RealWebSocket$Streams;
    :try_start_1
    ...
    .end local v4    # "pingIntervalNanos":J
    .end local v7    # "name":Ljava/lang/String;
    .end local v8    # "streams":Lokhttp3/internal/ws/RealWebSocket$Streams;
    .end local v10    # "this_$iv":Lokhttp3/internal/concurrent/TaskQueue;
    .end local v11    # "$i$f$schedule":I
    .restart local p1    # "name":Ljava/lang/String;
    .restart local p2    # "streams":Lokhttp3/internal/ws/RealWebSocket$Streams;
    :cond_0
    move-object v6, p0
    ...
    .restart local v8    # "streams":Lokhttp3/internal/ws/RealWebSocket$Streams;
    :goto_0
...
.method public final writeOneFrame$okhttp()Z
    ...
    .line 483
    .local v8, "messageOrClose":Lkotlin/jvm/internal/Ref$ObjectRef;
    ...
    .line 484
    .local v9, "receivedCloseCode":Lkotlin/jvm/internal/Ref$IntRef;
    ...
    .line 485
    .local v10, "receivedCloseReason":Lkotlin/jvm/internal/Ref$ObjectRef;
    ...
    .line 487
    .local v12, "readerToClose":Lkotlin/jvm/internal/Ref$ObjectRef;
    ...
    .line 489
    .local v13, "writerToClose":Lkotlin/jvm/internal/Ref$ObjectRef;
    monitor-enter p0

    const/4 v14, 0x0

    .line 490
    .local v14, "$i$a$-synchronized-RealWebSocket$writeOneFrame$1":I
    :try_start_0
    ...
    .end local v14    # "$i$a$-synchronized-RealWebSocket$writeOneFrame$1":I
    monitor-exit p0

    return v6

    .line 494
    .restart local v14    # "$i$a$-synchronized-RealWebSocket$writeOneFrame$1":I
    :cond_0
    :try_start_1
    ...
    .line 512
    .local v2, "cancelAfterCloseMillis":J
    iget-object v0, v5, Lokhttp3/internal/ws/RealWebSocket;->taskQueue:Lokhttp3/internal/concurrent/TaskQueue;
    ...
    .local v15, "delayNanos$iv":J
    move-wide/from16 v17, v15

    .line 664
    .end local v15    # "delayNanos$iv":J
    .local v17, "delayNanos$iv":J
    move-wide v15, v2

    .end local v2    # "cancelAfterCloseMillis":J
    .local v15, "cancelAfterCloseMillis":J
    const/4 v2, 0x1
    ...
    .local v6, "this_$iv":Lokhttp3/internal/concurrent/TaskQueue;
    move-object v3, v4
    ...
    .local v6, "writer":Lokhttp3/internal/ws/WebSocketWriter;
    .local v20, "this_$iv":Lokhttp3/internal/concurrent/TaskQueue;
    move v4, v2
    ...
    .local v20, "$i$a$-synchronized-RealWebSocket$writeOneFrame$1":I
    :try_start_3
    ...
    .end local v6    # "writer":Lokhttp3/internal/ws/WebSocketWriter;
    .local v1, "writer":Lokhttp3/internal/ws/WebSocketWriter;
    ...
    .end local v17    # "delayNanos$iv":J
    .local v2, "delayNanos$iv":J
    .local v6, "cancelable$iv":Z
    ...
    .end local v6    # "writer":Lokhttp3/internal/ws/WebSocketWriter;
    .restart local v1    # "writer":Lokhttp3/internal/ws/WebSocketWriter;
    goto/16 :goto_2
    ...
    .end local v14    # "$i$a$-synchronized-RealWebSocket$writeOneFrame$1":I
    .restart local v20    # "$i$a$-synchronized-RealWebSocket$writeOneFrame$1":I
    ...
    .end local v8    # "messageOrClose":Lkotlin/jvm/internal/Ref$ObjectRef;
    .end local v9    # "receivedCloseCode":Lkotlin/jvm/internal/Ref$IntRef;
    .end local v10    # "receivedCloseReason":Lkotlin/jvm/internal/Ref$ObjectRef;
    .end local v11    # "streamsToClose":Lkotlin/jvm/internal/Ref$ObjectRef;
    .end local v12    # "readerToClose":Lkotlin/jvm/internal/Ref$ObjectRef;
    .end local v13    # "writerToClose":Lkotlin/jvm/internal/Ref$ObjectRef;
    throw v0
    ...
    .restart local v8    # "messageOrClose":Lkotlin/jvm/internal/Ref$ObjectRef;
    .restart local v9    # "receivedCloseCode":Lkotlin/jvm/internal/Ref$IntRef;
    .restart local v10    # "receivedCloseReason":Lkotlin/jvm/internal/Ref$ObjectRef;
    .restart local v11    # "streamsToClose":Lkotlin/jvm/internal/Ref$ObjectRef;
    .restart local v12    # "readerToClose":Lkotlin/jvm/internal/Ref$ObjectRef;
    .restart local v13    # "writerToClose":Lkotlin/jvm/internal/Ref$ObjectRef;
    .restart local v14    # "$i$a$-synchronized-RealWebSocket$writeOneFrame$1":I
    :cond_3
    move/from16 v20, v14
