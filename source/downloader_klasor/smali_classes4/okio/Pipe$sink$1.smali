...
.method public write(Lokio/Buffer;J)V
    ...
    .local v10, "it":Lokio/Sink;
    const/4 v8, 0x0

    .line 60
    .local v8, "$i$a$-let-Pipe$sink$1$write$1$2":I
    move-object v5, v10
    ...
    .line 64
    .end local v8    # "$i$a$-let-Pipe$sink$1$write$1$2":I
    .end local v10    # "it":Lokio/Sink;
    :cond_0
    iget-object v10, v1, Lokio/Pipe$sink$1;->this$0:Lokio/Pipe;
    ...
    .local v17, "$this$forward$iv":Lokio/Sink;
    invoke-virtual {v9}, Lokio/Timeout;->timeoutNanos()J
    ...
    .line 257
    .local v5, "originalDeadline$iv$iv":J
    ...
    .line 269
    .end local v5    # "originalDeadline$iv$iv":J
    :cond_9
    invoke-virtual {v10}, Lokio/Timeout;->hasDeadline()Z
    ...
    .line 80
    .local v5, "$i$a$-forward-Pipe$sink$1$write$2":I
    :try_start_3
    invoke-interface {v1, v2, v3, v4}, Lokio/Sink;->write(Lokio/Buffer;J)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_1
    ...
    .end local v0    # "$i$a$-intersectWith-Pipe$forward$1$iv":I
    .end local v1    # "$this$forward":Lokio/Sink;
    .end local v5    # "$i$a$-forward-Pipe$sink$1$write$2":I
    sget-object v0, Ljava/util/concurrent/TimeUnit;->NANOSECONDS:Ljava/util/concurrent/TimeUnit;
    ...
    .end local v17    # "$this$forward$iv":Lokio/Sink;
    goto :goto_3

    .line 279
    .restart local v7    # "this_$iv":Lokio/Pipe;
    .restart local v8    # "$i$f$forward":I
    ...
    .restart local v17    # "$this$forward$iv":Lokio/Sink;
    :catchall_1
    move-exception v0
