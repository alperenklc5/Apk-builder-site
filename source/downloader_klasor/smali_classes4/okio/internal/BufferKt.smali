...
.method public static final commonIndexOf(Lokio/Buffer;Lokio/ByteString;J)J
    ...
    .local v29, "$this$seek$iv":Lokio/Buffer;
    int-to-long v1, v0
    ...
    .end local v6    # "s":Lokio/Segment;
    .restart local v21    # "s":Lokio/Segment;
    ...
    .end local v29    # "$this$seek$iv":Lokio/Buffer;
    .local v0, "$i$f$commonIndexOf":I
    .local v1, "$this$seek$iv":Lokio/Buffer;
    :cond_6
    return-wide v19
    ...
    .restart local v29    # "$this$seek$iv":Lokio/Buffer;
    ...
    .line 1273
    .restart local v15    # "targetByteArray":[B
    ...
    .local v27, "$i$a$-seek-BufferKt$commonIndexOf$5":I
    int-to-long v2, v1
    ...
    .end local v27    # "$i$a$-seek-BufferKt$commonIndexOf$5":I
    .local v0, "offset$iv":J
    .local v2, "s":Lokio/Segment;
    .local v3, "$i$a$-seek-BufferKt$commonIndexOf$5":I
    :cond_c
...
.method public static final commonIndexOfElement(Lokio/Buffer;Lokio/ByteString;J)J
    ...
    .line 1301
    .local v20, "$i$a$-seek-BufferKt$commonIndexOfElement$2":I
    if-eqz v12, :cond_b
    ...
    .local v25, "$i$f$commonIndexOfElement":I
    iget-object v1, v15, Lokio/Segment;->data:[B
    ...
    .end local v2    # "$this$seek$iv":Lokio/Buffer;
    .local v26, "$this$seek$iv":Lokio/Buffer;
    int-to-long v1, v1
    ...
    .end local v25    # "$i$f$commonIndexOfElement":I
    .end local v26    # "$this$seek$iv":Lokio/Buffer;
    .local v1, "$i$f$commonIndexOfElement":I
    .local v2, "$this$seek$iv":Lokio/Buffer;
    :cond_5
    move/from16 v25, v1
    ...
    .end local v1    # "$i$f$commonIndexOfElement":I
    .end local v2    # "$this$seek$iv":Lokio/Buffer;
    .restart local v25    # "$i$f$commonIndexOfElement":I
    .restart local v26    # "$this$seek$iv":Lokio/Buffer;
    goto/16 :goto_8
    ...
    .end local v13    # "offset":J
    .end local v16    # "offset$iv":J
    .end local v20    # "$i$a$-seek-BufferKt$commonIndexOfElement$2":I
    :cond_c
    move/from16 v25, v1
    ...
    .end local v24    # "targetByteArray":[B
    .local v0, "targetByteArray":[B
    ...
    .restart local v24    # "targetByteArray":[B
    iget v0, v13, Lokio/Segment;->limit:I
...
.method public static final commonReadDecimalLong(Lokio/Buffer;)J
    ...
    .end local v18    # "buffer":Lokio/Buffer;
...
.method public static final commonWrite(Lokio/Buffer;Lokio/Buffer;J)V
    ...
    .line 1201
    .local v2, "segmentToMove":Lokio/Segment;
    invoke-static {v2}, Lkotlin/jvm/internal/Intrinsics;->checkNotNull(Ljava/lang/Object;)V
    ...
    .line 1181
    .end local v2    # "segmentToMove":Lokio/Segment;
    .end local v3    # "movedByteCount":J
    goto/16 :goto_1
