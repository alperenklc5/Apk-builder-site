...
.method public static final commonIndexOf(Lokio/RealBufferedSource;BJJ)J
    ...
    .local v13, "this_$iv":Lokio/RealBufferedSource;
    const/4 v14, 0x0
    ...
    .line 322
    .end local v13    # "this_$iv":Lokio/RealBufferedSource;
    ...
    .line 315
    .end local v1    # "lastBufferSize":J
    .end local v10    # "result":J
    goto :goto_2

    .line 322
    .restart local v1    # "lastBufferSize":J
...
.method public static final commonIndexOf(Lokio/RealBufferedSource;Lokio/ByteString;J)J
    ...
    .line 332
    .local v3, "$i$a$-check-RealBufferedSourceKt$commonIndexOf$3":I
    nop

    .end local v3    # "$i$a$-check-RealBufferedSourceKt$commonIndexOf$3":I
    new-instance v3, Ljava/lang/IllegalStateException;
...
.method public static final commonIndexOfElement(Lokio/RealBufferedSource;Lokio/ByteString;J)J
    ...
    .line 348
    .local v3, "$i$a$-check-RealBufferedSourceKt$commonIndexOfElement$1":I
    nop

    .end local v3    # "$i$a$-check-RealBufferedSourceKt$commonIndexOfElement$1":I
    new-instance v3, Ljava/lang/IllegalStateException;
...
.method public static final commonReadUtf8LineStrict(Lokio/RealBufferedSource;J)Ljava/lang/String;
    ...
    .restart local v9    # "this_$iv":Lokio/RealBufferedSource;
    const/4 v10, 0x0

    .line 442
    .restart local v10    # "$i$f$getBuffer":I
    iget-object v9, v9, Lokio/RealBufferedSource;->bufferField:Lokio/Buffer;
    ...
    .line 195
    .local v1, "$i$a$-require-RealBufferedSourceKt$commonReadUtf8LineStrict$1":I
    new-instance v2, Ljava/lang/StringBuilder;
    ...
    .end local v1    # "$i$a$-require-RealBufferedSourceKt$commonReadUtf8LineStrict$1":I
    new-instance v2, Ljava/lang/IllegalArgumentException;
